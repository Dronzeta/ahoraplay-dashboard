...
def fetch_metricool_data(network):
    ...
    print(f"🔍 Consultando {network} vía requests...")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ {network} falló con código {response.status_code}: {response.text[:100]}")
            # Intento desesperado: Ruta base sin /posts
        ...
        print(f"❌ Error de conexión en {network}: {e}")
        return []
